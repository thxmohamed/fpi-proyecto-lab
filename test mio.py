...
def cambia_ventana():
    ...
    def siguiente():
        ...
        def siguiente2():
            ...
            horario2.withdraw()
            horario3=Toplevel()
            horario3.title("Horario")
            horario3.geometry("400x663")

            bloque1 = Frame(horario3)
            textoB1 = Label(horario3, text = "Bloque 1", bg = "orange", font = ("Arial",14)).grid(row = 1, column = 0)
            bloque1.config(bg = "orange", width = 100, height =  100)
            bloque1.grid(row = 1, column = 0)

            bloque2 = Frame(horario3)
            textoB2 = Label(horario3, text = "Bloque 2", bg = "darkorange", font = ("Arial",14)).grid(row = 2, column = 0)
            bloque2.config(bg = "darkorange", width = 100, height = 100)
            bloque2.grid(row = 2, column =0)

            bloque3 = Frame(horario3)
            textoB3 = Label(horario3, text = "Bloque 3", bg = "orange", font = ("Arial",14)).grid(row = 3, column = 0)
            bloque3.config(bg = "orange", width = 100, height = 100)
            bloque3.grid(row = 3, column =0)

            bloque4 = Frame(horario3)
            textoB4 = Label(horario3, text = "Bloque 4", bg = "darkorange", font = ("Arial",14)).grid(row = 4, column = 0)
            bloque4.config(bg = "darkorange", width = 100, height = 100)
            bloque4.grid(row = 4, column =0)

            bloque5 = Frame(horario3)
            textoB5 = Label(horario3, text = "Bloque 5", bg = "orange", font = ("Arial",14)).grid(row = 5, column = 0)
            bloque5.config(bg = "orange", width = 100, height = 100)
            bloque5.grid(row = 5, column =0)

            bloque6 = Frame(horario3)
            textoB6 = Label(horario3, text = "Bloque 6", bg = "darkorange", font = ("Arial",14)).grid(row = 6, column = 0)
            bloque6.config(bg = "darkorange", width = 100, height = 100)
            bloque6.grid(row = 6, column =0)

            #Viernes

            viernes = Frame(horario3)
            textoV = Label(horario3, text = "Viernes", bg = "orange", font = ("Arial",14)).grid(row = 0, column = 1)
            viernes.config(bg = "orange", width = 150, height = 30)
            viernes.grid(row = 0, column = 1)

            viernes1 = Frame(horario3)
            viernes1.config(bg = "lightgreen", width = 150, height = 100)
            viernes1.grid(row = 1, column = 1)

            viernes2 = Frame(horario3)
            viernes2.config(bg = "lightblue", width = 150, height = 100)
            viernes2.grid(row = 2, column = 1)

            viernes3 = Frame(horario3)
            viernes3.config(bg = "lightgreen", width = 150, height = 100)
            viernes3.grid(row = 3, column = 1)

            viernes4 = Frame(horario3)
            viernes4.config(bg = "lightblue", width = 150, height = 100)
            viernes4.grid(row = 4, column = 1)

            viernes5 = Frame(horario3)
            viernes5.config(bg = "lightgreen", width = 150, height = 100)
            viernes5.grid(row = 5, column = 1)

            viernes6 = Frame(horario3)
            viernes6.config(bg = "lightblue", width = 150, height = 100)
            viernes6.grid(row = 6, column = 1)

            #Sábado
            sabado1 = Frame(horario3)
            sabado1.config(bg = "lightblue", width = 150, height = 100)
            sabado1.grid(row = 1, column = 2)

            sabado = Frame(horario3)
            textoS = Label(horario3, text = "Sábado", bg = "darkorange", font = ("Arial",14)).grid(row = 0, column = 2)
            sabado.config(bg = "darkorange", width = 150, height = 30)
            sabado.grid(row = 0, column =2)

            sabado2 = Frame(horario3)
            sabado2.config(bg = "lightgreen", width = 150, height = 100)
            sabado2.grid(row = 2, column = 2)

            sabado3 = Frame(horario3)
            sabado3.config(bg = "lightblue", width = 150, height = 100)
            sabado3.grid(row = 3, column = 2)

            sabado4 = Frame(horario3)
            sabado4.config(bg = "lightgreen", width = 150, height = 100)
            sabado4.grid(row = 4, column = 2)

            sabado5 = Frame(horario3)
            sabado5.config(bg = "lightblue", width = 150, height = 100)
            sabado5.grid(row = 5, column = 2)

            sabado6 = Frame(horario3)
            sabado6.config(bg = "lightgreen", width = 150, height = 100)
            sabado6.grid(row = 6, column = 2)
            
            boton = Button(horario3, text = "Agregar", bg= "cyan", font = ("Arial",11), padx=17.5, pady= 2.1, command = ventana_entra_act).grid(row=0, column = 0)
            boton_cerrar = Button(horario3, text = "Finalizar Programa", command = root.destroy, bg = "red", fg = "white", font = ("Arial", 12)).grid(row = 7, column = 1)
            boton_atras = Button(horario3, text = "Atrás", bg= "cyan", font = ("Arial",11), padx= 27.4, pady= 2.1, command = siguiente).grid(row=7, column = 0)
        ...
        boton_siguiente = Button(horario2, text = "Siguiente", bg= "cyan", font = ("Arial",11), padx= 39.4, pady= 2.1, command = siguiente2).grid(row=7, column = 2)
